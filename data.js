// Data dibagi: Dasar + Perubahan (tenten/maru)
const KANA_DATA = {
  hiragana: {
    basic: [
...
const HIRAGANA = KANA_DATA.hiragana.basic.concat(KANA_DATA.hiragana.modified);
const KATAKANA = KANA_DATA.katakana.basic.concat(KANA_DATA.katakana.modified);
